...
namespace FairyJam.UI
{
    public static class MainHUD
    {
        ...
        public static void Draw()
        {
            ...
            Window.window.DrawTextCentered("+12", 140, 40, 0, 1, 0, 1, true, ResourceFontBot);
            // Materials
            ...
            Window.window.DrawTextCentered("+12", 265, 40, 0, 1, 0, 1, true, ResourceFontBot);
            // Food
            ...
            Window.window.DrawTextCentered("+12", 390, 40, 0, 1, 0, 1, true, ResourceFontBot);
            // Fuel
            ...
            Window.window.DrawTextCentered("+12", 515, 40, 0, 1, 0, 1, true, ResourceFontBot);
            // Population
            ...
            Window.window.DrawTextCentered("+12", 640, 40, 0, 1, 0, 1, true, ResourceFontBot);
            // Happiness
            ...
            Window.window.DrawTextCentered("+12", 765, 40, 0, 1, 0, 1, true, ResourceFontBot);
            // Techpoints
            ...
            Window.window.DrawTextCentered("+12", 890, 40, 0, 1, 0, 1, true, ResourceFontBot);
